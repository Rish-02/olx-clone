...
const UpdateAd = () => {
  ...
  const statusDropDownChange = (e) => {
    setAllValues({ ...allValues, sellingStatus: e.target.value })
  }
  ...
  const handleSubmit = (e) => {
    ...
    allValues.sellingStatus && formData.append('sellingStatus', allValues.sellingStatus)
        ...
        <div className="contact_us_container">
          ...
          >
            <Row className="g-2 gy-4">
              ...
              <div>
                <p className="input_label">Selling Status</p>

                <Form.Select onChange={statusDropDownChange}>
